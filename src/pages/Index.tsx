        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="max-w-3xl mx-auto text-muted-foreground">
              I’m an NLP researcher and Fullstack developer with a background in
              linguistics, text mining, and machine learning. I enjoy building
              Machine Learning Models and web applications using Python and
              JavaScript. I also enjoy working on projects that combine
              research, data, and practical design.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-muted-foreground text-center">
                Strong background in creating modern, responsive web
                applications using React.js, Next.js, and Node.js, combining AI
                integration with practical design.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground text-center">
                Skilled in Python-based ML development using scikit-learn,
                PyTorch, and pandas, with experience in data preparation, model
            ...
            >
              ...
              <p className="text-muted-foreground text-center">
                Experienced in building and evaluating language models using
                BERT, spaCy, and Hugging Face, with a focus on model
