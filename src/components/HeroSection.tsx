          ...
          <div>
            ...
            >
              ...
              >
                <Link
                  to="/contact"
                  className="inline-flex items-center bg-teal-500 text-white px-6 py-3 rounded-lg font-medium transition-all"
                >
                  Get in Touch
              ...
              >
                <Link
                  to="/projects"
                  className="inline-flex items-center bg-secondary text-foreground px-6 py-3 rounded-lg font-medium transition-all"
                >
                  View Projects
                </Link>
              </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="relative  w-full h-[500px]">
                <div className="scroll-container grid gap-4">
                  ...
                  <div className="grid grid-cols-6 grid-rows-6 gap-4">
                    ...
                    <SkillCard
                      icon={Cpu}
                      title="ML"
                      description="Model development & training"
                      className="col-span-3 row-span-2"
                    />
                    ...
                    <SkillCard
                      icon={Box}
                      title="Docker"
                      description="Containerization & environments"
                      className="col-span-3 row-span-2"
                    />
                    <SkillCard
                      icon={Activity}
