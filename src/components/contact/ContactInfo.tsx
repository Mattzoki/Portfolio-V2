  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      details: "nikhil.mathews1997@gmail.com",
      link: "https://mail.google.com/mail/?view=cm&fs=1&to=nikhil.mathews1997@gmail.com",
    },
    {
      icon: <MapPin className="h-5 w-5 text-brand-purple" />,
      title: "Location",
      details: "Amsterdam, North holland, Netherlands",
      link: "https://maps.google.com/?q=Amsterdam",
    },
  ];
  ...
  const socialLinks = [
    {
      ...
      name: "GitHub",
      url: "https://github.com/Mattzoki",
    },
    {
      icon: <Linkedin className="h-5 w-5" />,
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/nikhilmathews1997/",
    },
  ];
  ...
  return (
    ...
    >
      <div className="glass-panel p-6 rounded-lg">
        <h2 className="text-xl font-bold mb-4 text-brand-purple">
          Contact Information
        </h2>
      ...
      <div className="glass-panel p-4 rounded-lg">
        ...
        <p className="text-sm text-muted-foreground">
          I typically reply within 8-10 hours during business days.
        </p>
      </div>
    </motion.div>
  );
