...
const ContactForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const serviceId = "service_mcltt0l";
      const templateId = "template_ch6jauf";
      const publicKey = "6iYbWew_IsPWn0um8";
      ...
      <div className="glass-panel p-6 rounded-lg">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <motion.textarea
                ...
                placeholder="Tell me a bit more about your project, your timeline, and what you’re hoping to achieve"
                whileFocus={{ boxShadow: "0 0 0 3px rgba(155, 135, 245, 0.3)" }}
              />
            </div>
          </div>
          ...
          <p className="text-xs text-muted-foreground text-center">
            I value your privacy. Your information will never be shared with
            third parties.
          </p>
        </form>
      </div>
